...
summary: "Can we prevent a model from encoding arbitrary concepts, such as gender, in its representations? We formulate the problem of identifying and erasing concept subspaces -- linear subspaces whose removal prevent linear classification of concepts. We show that existing techniques are not optimal for this task, and propose effective solutions."
